...
public class ActiveDirectory {
	...
	/**
	 * Contructor with parameters for initialize Microsoft Active Directory
	 * context
	 * 
	 * @param adHost
	 *            AD server host name or ip, like 192.168.10.1
	 * @param adPort
	 *            AD server port, always 389
	 * @param bindUser
	 *            The user'name to bind the server for user profile, usually
	 *            have admin privilege
	 * @param bindPwd
	 *            The password for binding user
	 * @param domain
	 *            the domain controller, like "example.com"
	 * @throws NamingException
	 */
	public ActiveDirectory(String adHost, int adPort, String bindUser, String bindPwd, String domain)
			throws NamingException {
	 ...
	 * 
	 * @param searchBy
	 *            Support two types at present, "email" and "username"
	 * @param searchValue
	 *            The searching value corresponding to searchBy type
	 * @param searchBase
	 *            Null or a String value like "example.com"
	 * @return searchResults The search results
	 * @throws NamingException
	 */
	public NamingEnumeration<SearchResult> searchUser(String searchBy, String searchValue, String searchBase)
			throws NamingException {
